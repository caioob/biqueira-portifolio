...
describe('canonicalSrc', () => {
  it('maps any upload format to its WebP path', () => {
    ...
    expect(canonicalSrc('/images/projects/foo.mp.jpg')).toBe('/images/projects/foo.mp.webp')
  })

  it('leaves a WebP path unchanged', () => {
    expect(canonicalSrc('/images/projects/OVO-thumb.webp')).toBe('/images/projects/OVO-thumb.webp')
  })
})
...
describe('variantSrc', () => {
  ...
  it('normalizes a non-webp upload to a webp variant', () => {
    expect(variantSrc('/images/projects/photo.jpg', 640)).toBe('/images/projects/photo-640.webp')
  })
})
...
describe('srcSetFor', () => {
  ...
  it('uses the canonical webp form for a non-webp upload src', () => {
    expect(srcSetFor('/images/projects/photo.jpg', 'gallery', 640)).toBe(
      '/images/projects/photo.webp 640w',
    )
  })
})
